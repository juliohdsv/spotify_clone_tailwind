export default function Footer(){
    return(
            <div className="container-footer grid grid-cols-1 md:grid-cols-6 bg-black text-white p-4 md:p-20">
                <div className="md:col-span-1 pt-10 md:pt-0">
                    <a href="#"></a>
                    <img src="img/spotify-logo.png" alt="Logo spotify" className="w-20 md:w-132px"/>
                </div>
